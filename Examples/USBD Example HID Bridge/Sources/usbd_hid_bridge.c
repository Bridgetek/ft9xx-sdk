/**
  @file usbd_hid_bridge.c
  @brief
  USB HID Device Bridge

  This example program will send buffer received on the UART input to the host
  as HID reports. It will effectively make a keyboard out of a UART input.
 */
/*
 * ============================================================================
 * History
 ...
 */
//@{
#define USBD_HID_UART_KEYS
// Debugging only
#undef USBD_HID_KEYSCAN_CODES
//@}
