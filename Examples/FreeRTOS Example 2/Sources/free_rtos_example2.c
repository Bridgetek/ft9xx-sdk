/**
  ...
  Free RTOS Example 2
	...
	the use of Semaphores, Queues, Events and Dynamic Priority assignment to tasks.
	The code is ported from the demos available within the FreeRTOS distribution.
*/
/*
 * ============================================================================
 * History
