...
/**
    ...
    @brief Enums used to configure whether the endpoint handles one or two or three 1024-byte
...
/**
    @brief      Sets SEQEND to terminate a video frame so that the hardware automatically generates
                the frame end payload for UVC
 **/
