 ...
 *  @brief Identified a Configuration Descriptor as a DFU Function Descriptor with fields as laid
 *         out in USB_dfu_functional_descriptor.
 **/
#define USB_DESCRIPTOR_TYPE_DFU_FUNCTIONAL 0x21

/** @name USB Functional Descriptor Attributes
 *  @brief Bitmap of features supported by the DFU. Used in bmAttributes field of
