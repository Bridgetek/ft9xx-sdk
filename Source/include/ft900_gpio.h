...
typedef enum
{
  ...
  pad_pwm3_2      = pad_func_2, /**< PWM3/UART0_RXD/GPIO22 Pad function 2 */
  pad_pwm2_2      = pad_func_2, /**< PWM2/UART0_TXD/GPIO23 Pad function 2 */
  pad_pwm1_2      = pad_func_2, /**< PWM1/UART0_RTS/GPIO24 Pad function 2 */
  pad_pwm0_2      = pad_func_2, /**< PWM0/UART0_CTS/GPIO25 Pad function 2 */
  ...
  pad_spis0_clk_2 = pad_func_2, /**< SPIM_CLK/SPIS_CLK/GPIO34 Pad function 2 */
  pad_spis0_miso_2= pad_func_2, /**< SPIS_MISO/SPIM_MISO/GPIO35 Pad function 2 */
  pad_spis0_mosi_2= pad_func_2, /**< SPIS_MOSI/SPIM_MOSI/GPIO36 Pad function 2 */
  pad_spis0_ss_2  = pad_func_2, /**< SPIS_SS/SPIM_IO2/GPIO37 Pad function 2 */
  pad_rtc_ref     = pad_func_2, /**< RTC_REF/SPIM_IO3/GPIO38 Pad function 2 */

  pad_spim_ss0_3  = pad_func_3, /**< SPIM_SS0/UART1_CTS/UART0_RI/GPIO29 Pad function 3 */
  pad_pwm0_3      = pad_func_3, /**< PWM0/SD_DATA1/PWM7/GPIO4 Pad function 3 */
  pad_pwm1_3      = pad_func_3, /**< PWM1/SD_DATA2/PWM6/GPIO5 Pad function 3 */
} pad_func_t;
...
typedef enum
{
  ...
  gpio_pwm3_2      = 22, /**< PWM3/UART0_RXD/GPIO22 Pad function 2 */
  gpio_pwm2_2      = 23, /**< PWM2/UART0_TXD/GPIO23 Pad function 2 */
  gpio_pwm1_2      = 24, /**< PWM1/UART0_RTS/GPIO24 Pad function 2 */
  gpio_pwm0_2      = 25, /**< PWM0/UART0_CTS/GPIO25 Pad function 2 */
  ...
  gpio_spis0_clk_2 = 34, /**< SPIM_CLK/SPIS_CLK/GPIO34 Pad function 2 */
  gpio_spis0_miso_2= 35, /**< SPIS_MISO/SPIM_MISO/GPIO35 Pad function 2 */
  gpio_spis0_mosi_2= 36, /**< SPIS_MOSI/SPIM_MOSI/GPIO36 Pad function 2 */
  gpio_spis0_ss_2  = 37, /**< SPIS_SS/SPIM_IO2/GPIO37 Pad function 2 */
  gpio_rtc_ref     = 38, /**< RTC_REF/SPIM_IO3/GPIO38 Pad function 2 */

  gpio_spim_ss0_3  = 29, /**< SPIM_SS0/UART1_CTS/UART0_RI/GPIO29 Pad function 3 */
  gpio_pwm0_3      = 4,  /**< PWM0/SD_DATA1/PWM7/GPIO4 Pad function 3 */
  gpio_pwm1_3      = 5,  /**< PWM1/SD_DATA2/PWM6/GPIO5 Pad function 3 */
} gpio_func_t;
 ...
 *  @param [in] num  - The GPIO number
 *  @param [in] slew - The slew rate of the pin
 *  @returns On success a 0, otherwise -1
 */
 ...
 *  @param [in] num     - The GPIO number
 *  @param [in] schmitt - The Schmitt trigger configuration
 *  @returns On success a 0, otherwise -1
 */
 ...
 *  @param [in] num  - The GPIO number
 *  @param [in] pull - The pullup/down configuration
 *  @returns On success a 0, otherwise -1
 */
 ...
 *  @param [in] num   - The GPIO number
 *  @param [in] drive - The maximum current
 *  @returns On success a 0, otherwise -1
 */
 ...
 *  @param [in] num  - The GPIO number
 *  @param [in] func - The function that the pin should use
 *  @returns On success a 0, otherwise -1
 */
 ...
 *  @param [in] num  - The GPIO number
 *  @param [in] edge - The edge at which to trigger on
 *  @returns On success a 0, otherwise -1
 */
