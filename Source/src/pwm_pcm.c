...
int8_t pwm_pcm_volume(pwm_pcm_volume_t vol)
{
  ...
  switch (vol)
  {
  case pwm_pcm_volume_mute:
    PWM->PCM_VOLUME = 0;
    break;
  case pwm_pcm_volume_6:
    PWM->PCM_VOLUME = 1;
    break;
  case pwm_pcm_volume_12:
    PWM->PCM_VOLUME = 2;
    break;
  case pwm_pcm_volume_19:
    PWM->PCM_VOLUME = 3;
    break;
  case pwm_pcm_volume_25:
    PWM->PCM_VOLUME = 4;
    break;
  case pwm_pcm_volume_31:
    PWM->PCM_VOLUME = 5;
    break;
  case pwm_pcm_volume_37:
    PWM->PCM_VOLUME = 6;
    break;
  case pwm_pcm_volume_44:
    PWM->PCM_VOLUME = 7;
    break;
  case pwm_pcm_volume_50:
    PWM->PCM_VOLUME = 8;
    break;
  case pwm_pcm_volume_56:
    PWM->PCM_VOLUME = 9;
    break;
  case pwm_pcm_volume_63:
    PWM->PCM_VOLUME = 10;
    break;
  case pwm_pcm_volume_69:
    PWM->PCM_VOLUME = 11;
    break;
  case pwm_pcm_volume_75:
    PWM->PCM_VOLUME = 12;
    break;
  case pwm_pcm_volume_81:
    PWM->PCM_VOLUME = 13;
    break;
  case pwm_pcm_volume_88:
    PWM->PCM_VOLUME = 14;
    break;
  case pwm_pcm_volume_94:
    PWM->PCM_VOLUME = 15;
    break;
  case pwm_pcm_volume_100:
    PWM->PCM_VOLUME = 16;
    break;
  default:
    iRet = -1;
...
int8_t pwm_pcm_enable_interrupt(pwm_pcm_interrupt_t interrupt)
{
  ...
  case pwm_pcm_interrupt_empty:
    PWM->PWM_INTMASK |= MASK_PWM_INTMASK_FIFOEMPTY;
    break;
  case pwm_pcm_interrupt_full:
    PWM->PWM_INTMASK |= MASK_PWM_INTMASK_FIFOFULL;
    break;
  case pwm_pcm_interrupt_half_full:
    PWM->PWM_INTMASK |= MASK_PWM_INTMASK_FIFOHALF;
    break;
  case pwm_pcm_interrupt_overflow:
    PWM->PWM_INTMASK |= MASK_PWM_INTMASK_FIFOOVER;
    break;
  case pwm_pcm_interrupt_underflow:
    PWM->PWM_INTMASK |= MASK_PWM_INTMASK_FIFOUNDER;
    break;
  default:
    iRet = -1;
    break;
