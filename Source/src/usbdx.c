...
/** @brief Decode of USB_ENDPOINT_SIZE definitions into actual endpoint Max Packet size values.
...
static inline void usbdx_in_request(uint8_t pipe, const uint8_t *buffer, uint16_t len)
{
